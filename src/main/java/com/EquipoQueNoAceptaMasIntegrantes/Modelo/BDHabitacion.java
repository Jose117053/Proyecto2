...
public class BDHabitacion {
     ...
     */
    public  BDHabitacion(){
        habitaciones = new Habitacion[]{new Habitacion("Normal", 100,"Individual", false, false ),
                                         new Habitacion("Suite", 150, "King", false, true),
                                        new Habitacion("Suite vista al mar", 200, "King", true, true)};
    }
